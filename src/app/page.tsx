...
export default async function HomePage() {
  ...
  return (
    <section>
      <header className="bg-black text-green-400 py-20 mb-16 rounded-lg shadow-lg">
        <div className="flex items-center mb-4">
          <Image src="/avatar.jpg" alt="Avatar" width={96} height={96} className="rounded-full mr-6" />
          <div>
            <h1 className="text-6xl font-extrabold tracking-tight mb-2 text-green-400">Tech Blog</h1>
            <p className="text-xl text-green-300">分享Python爬虫和计算机技术</p>
          </div>
        </div>
