...
export default function CyberSidebar() {
    return (
        <aside className="w-full flex-shrink-0 space-y-6 lg:w-80">
            {/* Profile Card */}
            <div className="glass-panel edge-frame relative p-6">
                ...
                <div className="relative z-10 space-y-6">
                    ...
                    <div className="flex gap-4">
                        <div className="relative flex h-16 w-16 shrink-0 items-center justify-center overflow-hidden border-2 border-amber-200 bg-white">
                            <Image
                                src="/kali-logo.png"
                        ...
                        <div className="space-y-1">
                            <h2 className="text-xl font-display font-bold tracking-wide text-white">Stanley Chan</h2>
                            <div className="text-sm font-mono text-amber-200">@stanleychan87</div>
                            <div className="flex gap-2 mt-2 text-[10px] font-mono font-bold uppercase">
                                ...
                                <span className="border border-cyan-300 px-1.5 py-0.5 text-cyan-200">NETRUNNER</span>
                                <span className="border border-amber-300 px-1 py-0.5 px-1.5 text-amber-200">✉</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="border-l-2 border-cyan-300 pl-3">
                        <p className="font-mono text-xs italic leading-relaxed text-slate-300">
                            &quot;Sorrow calls no time that&apos;s gone!&quot;
                        </p>
                    </div>

                    {/* Social Links */}
                    <div className="flex flex-wrap gap-2 border-t border-slate-500/20 pt-3">
                        <a
                    ...
                    <div className="space-y-3 font-mono text-xs">
                        <div className="flex items-center gap-2">
                            <span className="w-12 text-slate-400">RAM</span>
                            <div className="relative h-2 flex-1 overflow-hidden bg-slate-800/90">
                                <div className="absolute left-0 top-0 h-full w-[64%] bg-amber-300 shadow-[0_0_10px_rgba(252,211,77,0.45)]" />
                            </div>
                            <span className="w-8 text-right font-bold text-amber-200">64%</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <span className="w-12 text-slate-400">ICE</span>
                            <div className="relative h-2 flex-1 overflow-hidden bg-slate-800/90">
                                <div className="absolute left-0 top-0 h-full w-[88%] bg-[#ff003c] shadow-[0_0_10px_rgba(255,0,60,0.45)]" />
                            </div>
                            <span className="text-[#ff003c] w-8 text-right font-bold">88%</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <span className="w-12 text-slate-400">UPLINK</span>
                            <div className="relative h-2 flex-1 overflow-hidden bg-slate-800/90">
                                <div className="absolute left-0 top-0 h-full w-[35%] bg-cyan-300 shadow-[0_0_10px_rgba(103,232,249,0.5)]" />
                            </div>
                            <span className="w-8 text-right font-bold text-cyan-200">42MS</span>
                        </div>
                    </div>

                    {/* Neural Activity Graph */}
                    <div className="space-y-2 border-t border-slate-500/20 pt-2">
                        <div className="mb-2 text-xs font-mono font-bold uppercase tracking-wider text-cyan-200">NEURAL ACTIVITY</div>
            ...
            <div className="glass-panel edge-frame relative space-y-4 p-5">
                {/* Decoration corner */}
                <div className="absolute right-0 top-0 h-2 w-2 border-r border-t border-cyan-300" />
                <div className="absolute bottom-0 left-0 h-2 w-2 border-b border-l border-cyan-300" />
                ...
                <div className="space-y-2 text-[10px] md:text-xs font-mono tracking-wide">
                    <div className="flex items-center justify-between border-b border-slate-500/20 pb-1">
                        <span className="text-slate-400">FIREWALL</span>
                        <span className="text-green-500 font-bold">ACTIVE</span>
                    </div>
                    <div className="flex items-center justify-between border-b border-slate-500/20 pb-1">
                        <span className="text-slate-400">TRACE_ROUTE</span>
                        <span className="text-[#ff003c] font-bold">BLOCKED</span>
                    </div>
                    <div className="flex items-center justify-between border-b border-slate-500/20 pb-1">
                        <span className="text-slate-400">DATA_FRAGMENTS</span>
                        <span className="font-bold text-cyan-200">476</span>
                    </div>
                    <div className="flex items-center justify-between pb-1">
                        <span className="text-slate-400">INDEX_NODES</span>
                        <span className="font-bold text-amber-200">899</span>
                    </div>
                </div>
                <div className="relative mt-4 h-1.5 w-full overflow-hidden bg-slate-800">
                    <div className="h-full w-[75%] bg-amber-300" />
